...
import { ApiOperation, ApiResponse, ApiUnauthorizedResponse, ApiBearerAuth, ApiNotFoundResponse, ApiForbiddenResponse } from '@nestjs/swagger';
...
export class RoomsController {
    ...
    @ApiOperation({
        ...
        description: 'Retrieves a paginated list of all rooms. Filter by active status.',
    })
    @ApiResponse({
        status: 200,
    ...
    @ApiOperation({
        ...
        description: 'Updates an existing meeting room. Requires ADMIN or GESTOR role.',
    })
    @ApiResponse({
        status: 200,
